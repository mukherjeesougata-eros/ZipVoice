...
if [ ${stage} -le 1 ] && [ ${stop_stage} -ge 1 ]; then
      ...
      python3 -m zipvoice.bin.train_zipvoice_distill \
            ...
            --distill-stage "first" \
            --exp-dir exp/zipvoice_distill_1stage_custom_libritts_setup \
            --start-epoch 5
fi
...
if [ ${stage} -le 3 ] && [ ${stop_stage} -ge 3 ]; then
      ...
      python3 -m zipvoice.bin.train_zipvoice_distill \
            ...
            --train-manifest data/fbank/custom_cuts_train.jsonl.gz \
            --dev-manifest data/fbank/custom_cuts_dev.jsonl.gz \
            --teacher-model exp/zipvoice_distill_1stage_custom_libritts_setup/epoch-6-avg-3.pt \
            --distill-stage second \
            --exp-dir exp/zipvoice_distill_custom_libritts_setup \
            --start-epoch 4
fi
