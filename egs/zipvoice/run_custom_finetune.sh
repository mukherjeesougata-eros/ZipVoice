...
export PYTHONPATH=/mnt/data0/Sougata/TTS/ZipVoice:$PYTHONPATH
...
download_dir=/mnt/data0/Sougata/TTS/ZipVoice/egs/zipvoice/download
...
for subset in train dev;do
      file_path=/mnt/data0/Sougata/TTS/ZipVoice/egs/zipvoice/data_finetune/raw/custom_${subset}.tsv
...
if [ ${stage} -le 1 ] && [ ${stop_stage} -ge 1 ]; then
      ...
      for subset in train dev;do
            python3 -m zipvoice.bin.prepare_dataset \
                  --tsv-path data_finetune/raw/custom_${subset}.tsv \
                  --prefix custom-finetune \
                  --subset ${subset} \
                  --num-jobs ${nj} \
                  --output-dir data_finetune/manifests
      done
...
#       for subset in train dev;do
#             python3 -m zipvoice.bin.prepare_tokens_custom \
...
if [ $stage -le 3 ] && [ $stop_stage -ge 3 ]; then
      ...
      for subset in train dev; do
            python3 -m zipvoice.bin.compute_fbank \
                  --source-dir data_finetune/manifests \
                  --dest-dir data_finetune/fbank \
...
if [ ${stage} -le 3 ] && [ ${stop_stage} -ge 3 ]; then
      ...
      python3 ./local/prepare_token_file_char.py \
            --manifest data_finetune/manifests/custom-finetune_cuts_train.jsonl.gz \
            --tokens data_finetune/tokens_custom.txt
fi
...
if [ ${stage} -le 4 ] && [ ${stop_stage} -ge 4 ]; then
      ...
      #export HF_TOKEN=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
...
if [ ${stage} -le 5 ] && [ ${stop_stage} -ge 5 ]; then
      ...
      python3 -m zipvoice.bin.train_zipvoice \
            ...
            --tokenizer ${tokenizer} \
            --token-file /mnt/data0/Sougata/TTS/ZipVoice/egs/zipvoice/data_finetune/tokens_custom.txt \
            --dataset custom \
            --train-manifest /mnt/data0/Sougata/TTS/ZipVoice/egs/zipvoice/data_finetune/fbank/custom-finetune_cuts_train.jsonl.gz \
            --dev-manifest /mnt/data0/Sougata/TTS/ZipVoice/egs/zipvoice/data_finetune/fbank/custom-finetune_cuts_dev.jsonl.gz \
